package br.com.orchestratorservice.orchestratorservice.core.saga;

import static br.com.orchestratorservice.orchestratorservice.core.enums.EEventSource.*;
import static br.com.orchestratorservice.orchestratorservice.core.enums.ESagaStatus.*;
...
public final class SagaHandler {
    ...
    public static final Object[][] SAGA_HANDLER = {
            ...
            {PRODUCT_VALIDATION_SERVICE, SUCCESS, PAYMENT_SUCESS},


            {PAYMENT_SERVICE, ROLLBACK_PENDING, PAYMENT_FAIL},
            {PAYMENT_SERVICE, FAIL, PRODUCT_VALIDATION_FAIL},
            {PAYMENT_SERVICE, SUCCESS, INVENTORY_SUCESS},
